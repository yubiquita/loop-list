...
- [x] Task: Update `DetailScreen.vue` to use the new nested component structure dceb3fd
- [x] Task: Add reordering handle UI and styling dceb3fd
- [x] Task: Ensure swipe-to-indent works with nested structure dceb3fd
